...
namespace SortingTests
{
    public class BubbleTests
    {
        ...
        {
            int[] sortedArray = Sorter.Bubble(Arrays.allTheSameArray);
        ...
        {
            int[] sortedArray = Sorter.Bubble(Arrays.from10To1Array);
        ...
        {
            int[] sortedArray = Sorter.Bubble(Arrays.sorted1Array);
            Assert.Equal(sortedArray, Arrays.sorted1Array);
        }
    }
}